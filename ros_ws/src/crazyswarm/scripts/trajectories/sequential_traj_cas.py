        ...
        r = ca.if_else(t<=self.duration[0], self.r_all[0], 
                ca.if_else(t<=self.duration[1], self.r_all[1],
                           ca.if_else(t<=self.duration[2], self.r_all[2],
                                      ca.if_else(t<=self.duration[3], self.r_all[3], 
                                                 ca.if_else(t<=self.duration[4], self.r_all[4], 
                                                            ca.if_else(t<=self.duration[5], self.r_all[5], self.r_all[6]))))))
        ...
        rot_dir = ca.if_else(t<=self.duration[0], self.rot_dir_all[0],
                             ca.if_else(t<=self.duration[1], self.rot_dir_all[1],
                                        ca.if_else(t<=self.duration[2], self.rot_dir_all[2], 
                                                    ca.if_else(t<=self.duration[3], self.rot_dir_all[3], 
                                                                ca.if_else(t<=self.duration[4], self.rot_dir_all[4], 
                                                                              ca.if_else(t<=self.duration[5], self.rot_dir_all[5], self.rot_dir_all[6]))))))
        ...
        rot_rate = ca.if_else(t<=self.duration[0], self.rot_rate_all[0],
                              ca.if_else(t<=self.duration[1], self.rot_rate_all[1],
                                            ca.if_else(t<=self.duration[2], self.rot_rate_all[2],
                                                        ca.if_else(t<=self.duration[3], self.rot_rate_all[3], 
                                                                    ca.if_else(t<=self.duration[4], self.rot_rate_all[4], 
                                                                                ca.if_else(t<=self.duration[5], self.rot_rate_all[5], self.rot_rate_all[6]))))))
        ...
        init_angle = ca.if_else(t<=self.duration[0], self.init_angle_all[0],
                                ca.if_else(t<=self.duration[1], self.init_angle_all[1],
                                             ca.if_else(t<=self.duration[2], self.init_angle_all[2], 
                                                        ca.if_else(t<=self.duration[3], self.init_angle_all[3], 
                                                                     ca.if_else(t<=self.duration[4], self.init_angle_all[4], 
                                                                                ca.if_else(t<=self.duration[5], self.init_angle_all[5], self.init_angle_all[6]))))))
        ...
        x_init =  ca.if_else(t<=self.duration[0], self.xyz_all[0][0],
                             ca.if_else(t<=self.duration[1], self.xyz_all[1][0],
                                        ca.if_else(t<=self.duration[2], self.xyz_all[2][0],
                                                    ca.if_else(t<=self.duration[3], self.xyz_all[3][0],
                                                                ca.if_else(t<=self.duration[4], self.xyz_all[4][0],
                                                                              ca.if_else(t<=self.duration[5], self.xyz_all[5][0], self.xyz_all[6][0]))))))
        ...
        y_init =  ca.if_else(t<=self.duration[0], self.xyz_all[0][1],
                             ca.if_else(t<=self.duration[1], self.xyz_all[1][1],
                                        ca.if_else(t<=self.duration[2], self.xyz_all[2][1],
                                                    ca.if_else(t<=self.duration[3], self.xyz_all[3][1],
                                                                ca.if_else(t<=self.duration[4], self.xyz_all[4][1],
                                                                              ca.if_else(t<=self.duration[5], self.xyz_all[5][1], self.xyz_all[6][1]))))))
        ...
        t = ca.if_else(t<=self.duration[0], t,
                          ca.if_else(t<=self.duration[1], t - self.duration[0],
                                        ca.if_else(t<=self.duration[2], t - self.duration[1], 
                                                    ca.if_else(t<=self.duration[3], t - self.duration[2], 
                                                                ca.if_else(t<=self.duration[4], t - self.duration[3], 
                                                                              ca.if_else(t<=self.duration[5], t - self.duration[4], t - self.duration[5]))))))
